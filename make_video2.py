...
NARR=[
 ...
 "Molmo 2, in twenty twenty-five, brings this to real video. Point at an object — say, a car — and it follows that point through every frame, and timestamps the event. And to be precise: Molmo outputs points, not boxes. A segmentation mask can be derived from the point using SAM 2.",
