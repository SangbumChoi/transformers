...
"""Grounding DINO 2 model configuration"""
...
class GroundingDino2Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`GroundingDino2Model`]. It is used to instantiate a
    Grounding DINO 2 model according to the specified arguments, defining the model architecture. Instantiating a
    configuration with the defaults will yield a similar configuration to that of the Grounding DINO 2
    [superb-ai/grounding-dino2-tiny](https://huggingface.co/superb-ai/grounding-dino2-tiny) architecture.
    ...
    Args:
        ...
        num_queries (`int`, *optional*, defaults to 900):
            ...
            [`GroundingDino2Model`] can detect in a single image.
        ...
        two_stage (`bool`, *optional*, defaults to `True`):
            ...
            Grounding DINO 2, which are further fed into the decoder for iterative bounding box refinement.
    ...
    ```python
    >>> from transformers import GroundingDino2Config, GroundingDino2Model

    >>> # Initializing a Grounding DINO 2 superb-ai/grounding-dino2-tiny style configuration
    >>> configuration = GroundingDino2Config()

    >>> # Initializing a model (with random weights) from the superb-ai/grounding-dino2-tiny style configuration
    >>> model = GroundingDino2Model(configuration)

    >>> # Accessing the model configuration
    >>> configuration = model.config
    ```"""

    model_type = "grounding-dino2"
    attribute_map = {
        "hidden_size": "d_model",
