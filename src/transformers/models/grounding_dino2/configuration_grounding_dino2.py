...
"""groundingdino2 model configuration"""
...
class GroundingDino2Config(PretrainedConfig):
    ...
    groundingdino2 model according to the specified arguments, defining the model architecture. Instantiating a
    configuration with the defaults will yield a similar configuration to that of the groundingdino2
    ...
    Args:
        ...
        two_stage (`bool`, *optional*, defaults to `True`):
            ...
            groundingdino2, which are further fed into the decoder for iterative bounding box refinement.
    ...
    >>> # Initializing a groundingdino2 superb-ai/grounding-dino2-tiny style configuration
