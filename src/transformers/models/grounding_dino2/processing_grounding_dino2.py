...
class GroundingDino2ImagesKwargs(ImagesKwargs, total=False):
...
class GroundingDino2ProcessorKwargs(ProcessingKwargs, total=False):
    images_kwargs: GroundingDino2ImagesKwargs
    _defaults = {
        "text_kwargs": {
...
class GroundingDino2Processor(ProcessorMixin):
    r"""
    Constructs a Grounding DINO processor which wraps a Deformable DETR image processor and a BERT tokenizer into a
    single processor.

    [`GroundingDino2Processor`] offers all the functionalities of [`GroundingDino2ImageProcessor`] and
    [`AutoTokenizer`]. See the docstring of [`~GroundingDino2Processor.__call__`] and [`~GroundingDino2Processor.decode`]
    for more information.

    Args:
        image_processor (`GroundingDino2ImageProcessor`):
            An instance of [`GroundingDino2ImageProcessor`]. The image processor is a required input.
    ...
    def __call__(
        ...
        **kwargs: Unpack[GroundingDino2ProcessorKwargs],
        ...
        """
        This method uses [`GroundingDino2ImageProcessor.__call__`] method to prepare image(s) for the model, and
