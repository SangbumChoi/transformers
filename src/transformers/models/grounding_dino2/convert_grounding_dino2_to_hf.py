...
def get_grounding_dino2_config(model_name):
    ...
    config = GroundingDino2Config(backbone_config=backbone_config)
...
@torch.no_grad()
def convert_grounding_dino2_checkpoint(args):
    ...
    checkpoint_mapping = {
        "grounding-dino2-tiny": "https://huggingface.co/ShilongLiu/GroundingDino2/resolve/main/groundingdino_swint_ogc.pth",
        "grounding-dino2-base": "https://huggingface.co/ShilongLiu/GroundingDino2/resolve/main/groundingdino_swinb_cogcoor.pth",
    }
    # Define default GroundingDino2 configuation
    config = get_grounding_dino2_config(model_name)
    ...
    # Load HF model
    model = GroundingDino2ForObjectDetection(config)
    model.eval()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name",
        default="grounding-dino2-tiny",
        type=str,
        choices=["grounding-dino2-tiny", "grounding-dino2-base"],
        help="Name of the GroundingDino2 model you'd like to convert.",
    )
    parser.add_argument(
    ...
    convert_grounding_dino2_checkpoint(args)
